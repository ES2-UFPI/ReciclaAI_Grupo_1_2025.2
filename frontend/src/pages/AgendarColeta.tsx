...
import { listarColetasAgendadas, buscarColetasPorBairro } from "@/services/coletaService";
...
const AgendarColeta = () => {
  ...
  const selecionarEvento = (coleta: Coleta) => {
    navigate("/declaracao-materiais", { state: { coleta } });
  };
